import ImgPrueba from '@/img/imgS1.jpg'
...
export default function Player(){
    ...
    return(
        <>
            ...
            <div className="flex flex-row items-center p-1 border border-black">
                <div className="mr-3">
                    <img src={ImgPrueba} alt="ImgPrueba" height="54px" width="54px"  />
                </div>
                <div className="mr-5">
                    <p className="text-black text-sm hover:cursor-pointer hover:border-b border-black">Si Veo A Tu Mama</p>
                    <p className="text-black text-[11px]">Bad Bunny</p>
                </div>
                <div className="mr-5">
            ...
            <div className="flex flex-col justify-center items-center border border-black h-full w-[35%]">
            <div>
                <button className="">
            ...
            <div className="flex flex-row justify-center items-center">
                ...
                {/* Barra de progreso (simulada con un div) */}
                <div className="bg-gray-600 h-2 w-72 relative mx-3">
                    <div
                    className="bg-green-500 h-full"
                    style={{ width: '50%' }} // Cambia esto según el progreso real
                    />
                </div>
                <p className="text-[11px]">3:00</p>
            </div>
            </div>
            ...
            <div className="mr-3 flex flex-row justify-center items-center">
                ...
                {/* Barra de progreso (simulada con un div) */}
                <div className="bg-gray-600 h-2 w-52 relative ml-2">
                    <div
                    className="bg-green-500 h-full"
                    style={{ width: '50%' }} // Cambia esto según el progreso real
                    />
